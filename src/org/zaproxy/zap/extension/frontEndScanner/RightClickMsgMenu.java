...
public class RightClickMsgMenu extends PopupMenuItemHttpMessageContainer {
    ...
    public RightClickMsgMenu(ExtensionFrontEndScanner ext, String label) {
        super(label);
        /*
    ...
    public void performAction(HttpMessage msg) {
        ...
        View.getSingleton().showMessageDialog(
                Constant.messages
                .getString(ExtensionFrontEndScanner.PREFIX + ".popup.msg", msg.getRequestHeader().getURI().toString()));
    }
